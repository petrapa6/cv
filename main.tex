...
\cventry{2019--present}{Researcher at Multi-Robot Systems laboratory, }{}{}{FEE CTU}{%
  --- \textbf{research:} resilient and reliable autonomy of mobile robots (mostly UAVs) in real-world settings | decentralized swarming\\
  --- \textbf{outputs:} co-development of the MRS UAV System (\Colorhref{https://github.com/ctu-mrs/mrs_uav_system}{Github}) | research applied in real practice (heritage preservation, speleology, search \& rescue, firefighting) | robotic experiments and competitions | demos for investors, industrial partners, students, and media | student supervision | project management | field popularization | academic teaching | summer schools and workshops organization}
...
\cventry{2018--2022}{Dronument (\Colorhref{https://www.youtube.com/watch?v=Gx-mBklSbYc}{video}): }{}{}{Documenting interiors of historical structures with autonomous aerial teams}{--- \textbf{contributions:} resilient \textbf{autonomous UAV team cooperating in interiors of historical structures} | robustness to geometrical symmetricity and other perceptual degradation | direct use in heritage preservation: deployed for documenting 18 historical objects (including 2 UNESCO sites)}
\cventry{2017-2024}{Swarming (\Colorhref{https://www.youtube.com/watch?v=Ax3ONfo1hMA}{video}): }{}{}{Decentralizing communication-less control of UAVs among obstacles}{--- \textbf{contributions:} bio-inspired algorithms for communication-less perception-aware coordination of UAV teams in obstacle-filled environments}
...
\cventry{2023--present}{Fly4Future s.r.o.: }{}{R\&D projects lead | grant writing | employee training}{}{}
\cvitem{}{%
  \vspace{-0.6em}
  \begin{itemize}
