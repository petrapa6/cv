...
--- 11 publications in impacted journals and 3 contributions to conference proceedings since 2019\\
--- \textbf{h-index}: 5 in WoS, 7 in Google Scholar, \textbf{citations count}: 69 in WoS, 176 in Google Scholar\\
...
\cvitem{Workshop presentations}{%
  ...
  \begin{itemize}
    ...
    \item \href{http://mrs.felk.cvut.cz/dronumentworkshop}{Dronument workshop} (organizer and speaker), \textit{hosted at FEE CTU}, 2021.
...
\vspace{0.5em}
\cvitem{Referee for journals}{Transactions on Cybernetics, Robotics and Automation Letters}
\cvitem[0.5em]{Referee for conference proceedings}{International Conference on Robotics and Automation (ICRA), International Conference on Intelligent Robots and Systems (IROS)}
\cvitem{Teaching experience}{Algorithms and Programming, Multi-Robot Aerial Systems}
