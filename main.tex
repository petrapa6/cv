...
--- 9 publications in impacted journals and 3 contributions to conference proceedings since 2019\\
--- \textbf{h-index}: 5 in WoS, 7 in Google Scholar, \textbf{citations count}: 64 in WoS, 152 in Google Scholar\\
