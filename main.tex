...
\cventry{Languages}{}{}{Czech (mothertongue), English}{}{}
...
{ --- \textbf{Ph.D. topic}: Robust UAV localization in perception-degraded environments\\
  ...
  --- \textbf{publication count} (since 2019): 11 impacted journals, 3 conference proceedings\\
  --- \textbf{h-index}: 5 in WoS, 8 in Google Scholar, \textbf{citations count}: 73 in WoS, 185 in Google Scholar}
...
\vspace{2mm}
\cventry{2019--present}{Doctoral candidate at Multi-Robot Systems research group, }{}{}{FEE CTU}{%
...
\cventry{2020--2022}{\Colorhref{http://mrs.felk.cvut.cz/projects/darpa}{DARPA Subterranean Challenge}: }{}{}{Exploration of unknown subterranean environments with a cooperative team of ground and aerial autonomous robots}{
  --- \textbf{contributions \& responsibilities:} Development of novel methods of lightweight perception, localization, and mapping of UAVs in perception-degraded environments, UAV system design, real-time systems integration, system evaluation and testing, key member for in situ deployment of aerial robots. Research published in several journal publications.}
\cventry{2018--present}{\Colorhref{http://mrs.felk.cvut.cz/ram2022dronument}{Dronument}: }{}{}{Documentation of interiors of historical structures with autonomous aerial robots}{--- \textbf{contributions \& responsibilities:} Development of a robust HW \& SW system capable of deploying a fully autonomous UAV team within interiors of historical structures. Focus on on-board UAV localization and prevention of its degeneracy in geometrically featureless environments. Deployment of the system for documenting 17 historical objects (including 2 UNESCO sites) with direct use for heritage preservation. Research published in several journal publications.}
...
\cvitem{Workshop presentations}{%
  \vspace{-0.6em}
  \begin{itemize}
    \item Practical seminar tasks introduction, \textit{In IEEE RAS Summer School on Multi-Robot Systems}, 2022.
...
\cvitem{Committee at conference proceedings}{%
  \vspace{-0.6em}
  \begin{itemize}
...
\vspace{0.5em}
\cvitem{Referee for journals}{%
  \vspace{-0.6em}
  \begin{itemize}
    \item Transactions on Cybernetics
    \item Robotics and Automation Letters
  \end{itemize}
}
\vspace{-1.0em}
\cvitem{Referee for conference proceedings}{%
  \vspace{-0.6em}
  \begin{itemize}
