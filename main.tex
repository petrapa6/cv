...
{ --- \textbf{dissertation}: Robust UAV localization in perception-degraded environments (\Colorhref{https://mrs.fel.cvut.cz/data/papers/petracek_phd_thesis.pdf}{pdf})\\
  ...
  --- \textbf{h-index}: 8 in WoS, 14 in Google Scholar, \textbf{citations count}: 170+ in WoS, 580+ in Google Scholar}
...
\cventry{2023--present}{Fly4Future s.r.o.: }{}{R\&D projects lead}{}{\hfill Utilizing my field experience in transferring state-of-the-art research in aerial robotics to industry}
\cvitem{}{%
  \vspace{-0.6em}
  \begin{itemize}
