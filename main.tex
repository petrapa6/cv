...
{ --- \textbf{Ph.D. topic}: Robust UAV localization in perception-degraded environments\\
  ...
  --- \textbf{h-index}: 7 in WoS, 13 in Google Scholar, \textbf{citations count}: 138 in WoS, 450 in Google Scholar}
